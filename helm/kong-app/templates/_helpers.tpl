...
{{- else }}
  image: "{{ .Values.ingressController.registry }}/{{ .Values.ingressController.image.repository }}:{{ .Values.ingressController.image.tag }}"
{{- end }}
  imagePullPolicy: {{ .Values.image.pullPolicy }}
  readinessProbe:
...
{{- else }}
  image: "{{ .Values.waitImage.registry }}/{{ .Values.waitImage.repository }}:{{ .Values.waitImage.tag }}"
{{- end }}
